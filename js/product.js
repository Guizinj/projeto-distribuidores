  ...
  container.innerHTML = [
    ...
    '<article class="container product-detail">',
      '<div class="product-gallery reveal">',
        '<div class="product-gallery__main"><img src="' + escapeHtml(product.image) + '" alt="Embalagem ilustrativa de ' + escapeHtml(product.name) + '" width="820" height="1230"></div>',
        '<p>Imagem ilustrativa · Apresentação profissional</p>',
      '</div>',
